...
ifeq ($(uname_S),SunOS)
  CFLAGS?= -pedantic -O0 -Wall -W -D__EXTENSIONS__ -D_XPG6
  CCLINK?= -ldl -lnsl -lsocket -lm
else
  CFLAGS?= -pedantic -O0 -Wall -W $(ARCH) $(PROF)
  CCLINK?= -lm
endif
CCOPT= $(CFLAGS) $(CCLINK) $(ARCH) $(PROF)
DEBUG?= -g -rdynamic -ggdb 

OBJ = adlist.o ae.o anet.o dict.o redis.o sds.o zmalloc.o lzf_c.o lzf_d.o pqsort.o rbtree.o rbtreeimpl.o
...
rbtreeimpl.o: zmalloc.h zmalloc.c rbtreeimpl.h rbtreeimpl.c
